<template>
  <div class="container-fluid">
    ...
    <section>
      <h1 class="text-center font-weight-bold w-100" style="color: var(--custom-primary-color) !important;">Africa, our continent!</h1>
      <br />
